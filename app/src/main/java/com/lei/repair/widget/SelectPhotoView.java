    ...
    private class SelectPhotoAdapter extends BaseAdapter{
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if(path==null||path.isEmpty()){
                //设置加号
                imgageView.setImageResource(R.drawable.add_picture);
                ...
                if(path.size()<MAX_NUM){
                    ...
                    if(position<this.path.size()) {
                        ...
                        Picasso.with(getContext()).load(new File(path)).placeholder(R.drawable.header).resize(100,100).into(imgageView);
